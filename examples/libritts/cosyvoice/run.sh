...
#   done
# fi
# data_dir=~/zhent/CosyVoice/examples/libritts/cosyvoice/
# for x in zpl_cleandata-denoise zpl_cleandata-denoise_dev; do
#   mkdir -p data/$x
#   python local/prepare_data.py --src_dir $x --des_dir data/$x
# done
...
for model in llm; do
  torchrun --nnodes=1 --nproc_per_node=$num_gpus \
    ...
    --config conf/cosyvoice.yaml \
    --train_data data/zpl_cleandata-denoise/parquet/data.list\
    --cv_data data/zpl_cleandata-denoise_dev/parquet/data.list \
    --model $model \
